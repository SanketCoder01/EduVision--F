-- Complete Cafeteria Module Setup with Full Data
...
-- 8. Insert all 7 cafeterias with complete details
...
-- 9. Add sample menu items for each cafeteria
DO $$
DECLARE
    sumit_id UUID;
    cc_id UUID;
...
BEGIN
    ...
    DELETE FROM menu_items WHERE cafeteria_id IN (sumit_id, cc_id, hp_id, snt_id, bharti_id, vaishnavi_id, dibre_id);
