...
import { Cpu, Shield, Brain, BookOpen, GraduationCap, Menu, X } from "lucide-react";
...
import imgRectangle3 from "figma:asset/ea8e8d140e41b2d63a986ae38069dbf9e1e00099.png";
import imgRectangle4 from "figma:asset/d725b057508306431566c6efaea04037dcfc30fe.png";
import imgRectangle5 from "figma:asset/fc75244eef1bf559aa4e60371bdf6d6d92ba0a91.png";
import imgRectangle6 from "figma:asset/b2850084f1f50d9cc6edf9ecc71cece8e41661e1.png";
import imgPexelsCanvaStudio31532011 from "figma:asset/ab8747b2fb703f485496ca1a73db84779ccb6a3b.png";
import imgIntersect from "figma:asset/b680986932606ce169ae13792a973a94af8f8079.png";
...
function HeroSection({ language, contentData }: { language: string, contentData?: ContentData }) {
  ...
  return (
    <div className="relative min-h-screen bg-white overflow-hidden pt-16 lg:pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-20">
          ...
          >
            ...
            >
              <span className="text-base sm:text-lg text-blue-600 font-medium tracking-wide">
            ...
            <motion.button
              className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-full font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl"
              whileHover={{
                scale: 1.05,
          ...
          >
            <motion.div
              className="relative w-full max-w-[600px] h-[400px] sm:h-[500px] lg:h-[600px] mx-auto"
          ...
          {safeDepartments.map((department: any, index: number) => (
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                {department.icon === "computer" && <Cpu className="w-8 h-8" />}
                {department.icon === "security" && <Shield className="w-8 h-8" />}
                {department.icon === "ai" && <Brain className="w-8 h-8" />}
                {department.icon === "ml" && <BookOpen className="w-8 h-8" />}
                {!["computer", "security", "ai", "ml"].includes(department.icon) && <GraduationCap className="w-8 h-8" />}
              </motion.div>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight max-w-4xl mx-auto mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {safeFeatures.map((feature: any, index: number) => (
            <motion.div
              key={index}
              className={`${
                index % 2 === 0 ? "bg-white border border-gray-200" : "bg-gradient-to-br from-blue-600 to-purple-600 text-white"
              } rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-auto min-h-[200px]`}
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              whileHover={{
                y: -5,
            ...
            >
              ...
              <p
                className={`text-sm leading-relaxed ${
                  index % 2 === 0 ? "text-gray-600" : "text-white opacity-90"
                }`}
              >
                {feature.description}
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {safeManagementTeam.length > 0 && (
          <>
            ...
            >
              <motion.div
                className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-blue-200 shadow-lg"
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">{safeManagementTeam[0].name}</h3>
              <p className="text-lg text-gray-600">{safeManagementTeam[0].position}</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {safeManagementTeam.slice(1).map((member: any, index: number) => (
                ...
                >
                  <motion.div
                    className="w-20 h-20 mx-auto mb-4 rounded-full overflow-hidden border-2 border-gray-200"
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.3 }}
                  >
                    <ImageWithFallback
...
function PlacementNewsSection({ contentData }: { contentData?: ContentData }) {
  ...
  const newsItems = contentData?.newsItems && contentData.newsItems.length > 0 
    ? contentData.newsItems.map(item => ({
        ...item,
        image: item.image || imgRectangle3
      }))
    : defaultNewsItems;
            ...
            >
              <div className="mb-12">
                <motion.img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-60 object-cover rounded-[15px] mb-6"
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.3 }}
                />
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          style={{
            backgroundImage: `url(${imgIntersect})`,
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="lg:col-span-1">
            ...
            >
              <img
                src={imgScreenshot20230807At4301}
                alt="EduVision Logo"
                className="w-full h-full object-cover"
              />
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {dept.faculty.map((faculty: any, index: number) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                whileHover={{ y: -5 }}
                transition={{ duration: 0.6, delay: 1.6 + index * 0.2, hover: { duration: 0.3 } }}
              >
...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "student-login":
        return <LoginPortal type="student" setCurrentPage={setCurrentPage} />;
      case "faculty-login":
        return <LoginPortal type="faculty" setCurrentPage={setCurrentPage} />;
      case "university-login":
        return <LoginPortal type="university" setCurrentPage={setCurrentPage} />;
      case "expert-login":
