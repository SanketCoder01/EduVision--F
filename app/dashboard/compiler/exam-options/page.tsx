  ...
  const options = [
    {
      id: 'create',
      title: 'Create Exam',
      description: 'Create secure exams with monitoring',
      icon: Plus,
      color: 'from-red-500 to-red-600',
      path: '/dashboard/compiler/exam'
    },
    {
      id: 'view',
      title: 'View Exam Details',
      description: 'View and manage exam details',
      icon: Eye,
      color: 'from-red-500 to-red-600',
      path: '/dashboard/compiler/view-exams'
    },
    {
      id: 'monitor',
      title: 'Monitor',
      ...
      icon: Monitor,
      color: 'from-red-500 to-red-600',
      path: '/dashboard/compiler/monitor-exams'
    },
    {
      id: 'submissions',
      title: 'Submission of Students',
      description: 'View student submissions',
      icon: Users,
      color: 'from-red-500 to-red-600',
      path: '/dashboard/compiler/submissions'
    }
  ]
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">
              Choose your exam management option
            </p>
          </div>
        </motion.div>
