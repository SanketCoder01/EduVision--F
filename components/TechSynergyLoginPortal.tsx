...
export function TechSynergyLoginPortal({ type, setCurrentPage }: LoginPortalProps) {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Redirect to the appropriate login page based on the type
    if (type === 'student') {
    ...
    } else if (type === 'expert' && credentials.email === 'sanketg367@gmail.com' && credentials.password === 'sanku@99') {
